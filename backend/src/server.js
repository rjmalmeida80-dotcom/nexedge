...
app.use('/api/medialoop', require('./routes/medialoop'));
app.use('/api/senhas', require('./routes/senhas'));
app.use('/api/copilot', require('./routes/ia-copilot'));
app.use('/api/motorista-portal', require('./routes/portal-motorista'));
app.use('/api/auto', require('./routes/automacoes-avancadas'));
app.use('/api/torre', require('./routes/torre-controlo'));
